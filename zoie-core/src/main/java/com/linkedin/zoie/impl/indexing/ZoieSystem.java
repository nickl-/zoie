...
import com.linkedin.zoie.api.impl.DefaultDocIDMapperFactory;
import com.linkedin.zoie.api.impl.util.FileUtil;
import com.linkedin.zoie.api.impl.util.SearchUtil;
import com.linkedin.zoie.api.indexing.AbstractZoieIndexable;
import com.linkedin.zoie.api.indexing.DefaultOptimizeScheduler;
import com.linkedin.zoie.api.indexing.IndexReaderDecorator;
import com.linkedin.zoie.api.indexing.IndexingEventListener;
import com.linkedin.zoie.api.indexing.OptimizeScheduler;
...
import com.linkedin.zoie.impl.indexing.internal.BatchedIndexDataLoader;
import com.linkedin.zoie.impl.indexing.internal.DefaultRAMIndexFactory;
import com.linkedin.zoie.impl.indexing.internal.DiskLuceneIndexDataLoader;
import com.linkedin.zoie.impl.indexing.internal.RAMIndexFactory;
import com.linkedin.zoie.impl.indexing.internal.RealtimeIndexDataLoader;
import com.linkedin.zoie.impl.indexing.internal.SearchIndexManager;
import com.linkedin.zoie.mbean.ZoieIndexingStatusAdmin;
import com.linkedin.zoie.mbean.ZoieIndexingStatusAdminMBean;
...
extends AsyncDataConsumer<D> implements Zoie<R, D>
{
   ...
   *          {@link com.linkedin.zoie.impl.indexing.DefaultIndexReaderDecorator} is
   *          used.
   * @param analyzer
  ...
  {
    this(dirMgr, interpreter, indexReaderDecorator, docidMapperFactory, analyzer, similarity, batchSize, batchDelay, rtIndexing, maxBatchSize, DefaultReaderCache.FACTORY, new DefaultRAMIndexFactory<R>(),versionComparator,skipBadRecord);
  }
  /**
   * Creates a new ZoieSystem.
   * 
   ...
   * @see com.linkedin.zoie.impl.indexing.AsyncDataConsumer#getVersion()
   */
  @Override
...
public boolean alreadyShutdown()
   ...
   * @see com.linkedin.zoie.api.IndexReaderFactory#getIndexReaders()
   */
   ...
   * 
   * @see com.linkedin.zoie.api.IndexReaderFactory#returnIndexReaders(java.util.List)
   */
  ...
  private class MyZoieSystemAdmin implements ZoieSystemAdminMBean
  {
     ...
     * (non-Javadoc)
     * 
     * @see com.linkedin.zoie.mbean.ZoieSystemAdminMBean#getDiskFreeSpaceBytes()
     */
