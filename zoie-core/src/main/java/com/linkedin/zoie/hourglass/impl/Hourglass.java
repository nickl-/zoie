...
public class Hourglass<R extends IndexReader, D> implements Zoie<R, D>
{
  ...
  /* (non-Javadoc)
   * @see com.linkedin.zoie.api.IndexReaderFactory#getAnalyzer()
   */
   ...
   * @see com.linkedin.zoie.hourglass.impl.Hourglass#returnIndexReaders(List)
  ...
  /* (non-Javadoc)
   * @see com.linkedin.zoie.api.DataConsumer#getVersion()
   */
  ...
  /* (non-Javadoc)
   * @see com.linkedin.zoie.api.DataConsumer#getVersionComparator()
   */
